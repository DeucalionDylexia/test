...
gulp.task('css-libs', ['sass','less', 'scss'], function() {
...
gulp.task('watch', ['browser-sync', 'css-libs', 'scripts', 'sprite'], function() {
    ...
    gulp.watch('app/sass/**/*.scss', ['scss']);            // Наблюдение за sass файлами в папке scss
    gulp.watch('app/less/**/*.less', ['less']);            // Наблюдение за sass файлами в папке less
    gulp.watch('app/icon/**/*.*', ['sprite']);              // Наблюдение за иконками в папке app/icons
...
gulp.task('sprite', function() {
    var spriteData = 
        gulp.src('app/icon/*.*') // путь, откуда берем картинки для спрайта
            .pipe(sprite({
                imgName: 'sprite.png',
                cssName: 'sprite.css',
            }));
...
gulp.task('build', ['clean', 'img', 'sass' , 'less', 'scss' , 'scripts'], function() {
